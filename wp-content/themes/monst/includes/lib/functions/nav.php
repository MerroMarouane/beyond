 ...
 * @package monst
 */
function monst_numeric_posts_nav() {
...
add_action('monst_entry_nav_footer', 'monst_image_nav_links', 25 );
function monst_image_nav_links() {
            ...
            <?php if($prev_post = get_previous_post()): ?>
                <li class="first-child">
                    ...
                    <a href="<?php echo get_permalink( $prev_post->ID ); ?>"  class="arrow">  <i class="icon-right-arrow"></i></a>
                        <div class="text">
<p><?php esc_html_e('Previous Post', 'monst') ?></p>
...
<p><?php esc_html_e('Next Post', 'monst') ?> </p>
<?php
