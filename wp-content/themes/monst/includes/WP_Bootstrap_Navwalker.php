	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			if ('mega_menu' == $item->object) {
				$megamenu_output      = monst_render_megamenu_content( $item->object_id );
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( '', 'monst' ) . '">' . esc_html__( '', 'monst' ) . '</a></li>';
			$fallback_output .= '</ul>';
