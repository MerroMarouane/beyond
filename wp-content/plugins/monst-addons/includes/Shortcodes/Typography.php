...
namespace Monstaddons\Shortcodes;
 ...
 class Typography{
      ...
      public function __construct() {
          ...
          add_action('monst_get_custom_typography_css', array($this, 'monst_typogrophy_css'));
      
      }

public static function monst_typogrophy_css(){
global $monst_theme_mod;
$css = '';
/*---typography-for-h1-desktop-*/
if(!empty($monst_theme_mod['font_family_enable']) == true){
$font_familt_commoncss = '';
$font_familt_common = $monst_theme_mod['font_familt_common']['font-family'];
$font_familt_commoncss = $font_familt_common ? '' . $font_familt_common . '!important; ' : '';
if(!empty($font_familt_commoncss)){
  $css .= ':root   {--monst-family-one:' . $font_familt_commoncss . '}';
}
 
$font_familt_common_twocss = '';
  $font_familt_common_two = $monst_theme_mod['font_familt_common_two']['font-family'];
  $font_familt_common_twocss = $font_familt_common_two ? '' . $font_familt_common_two . '!important; ' : '';
  if(!empty($font_familt_common_twocss)){
    $css .= ':root   {--monst-family-two:' . $font_familt_common_twocss . '}';
  }
}

if(!empty($monst_theme_mod['heading_style_h1_enable_desk']) == true){

$desk_h1_font_sizecss = '';
$desk_h1_font_size = $monst_theme_mod['h1_typography']['font-size'];
...
$desk_h1_font_weight = $monst_theme_mod['h1_typography']['font-weight'];
...
$desk_h1_font_style = $monst_theme_mod['h1_typography']['font-style'];
...
$desk_h1_lineheight = $monst_theme_mod['h1_typography']['line-height'];
...
if(!empty($monst_theme_mod['heading_style_h1_enable_mob']) == true){

  $mob_h1_font_sizecss = '';
  $mob_h1_font_size = $monst_theme_mod['h1_typography_mobile']['font-size'];
...
$css .= '@media(max-width:768px){ body h1 , h1 , h1 a  ' . ' {' . $mob_h1_font_sizecss . '}}';
  ...
  $mob_h1_font_lheight= $monst_theme_mod['h1_typography_mobile']['line-height'];
...
if(!empty($monst_theme_mod['heading_style_h2_enable_desk']) == true){

  $desk_h2_font_sizecss = '';
  $desk_h2_font_size = $monst_theme_mod['h2_typography']['font-size'];
...
$css .= '@media(min-width:768px){ body h2 , h2 , h2 a  ' . ' {' . $desk_h2_font_sizecss . '}}';
  ...
  $desk_h2_font_weight = $monst_theme_mod['h2_typography']['font-weight'];
...
$css .= 'body h2 , h2 , h2 a  ' . ' {' . $desk_h2_font_weightcss . '}';
  ...
  $desk_h2_font_style = $monst_theme_mod['h2_typography']['font-style'];
...
$css .= ' body h2 , h2 , h2 a  ' . ' {' . $desk_h2_font_stylecss . '}';
  ...
  $desk_h2_lineheight = $monst_theme_mod['h2_typography']['line-height'];
...
$css .= '@media(min-width:768px){ body h2 , h2 , h2 a  ' . ' {' . $desk_h2_lineheightcss . '}}';
  ...
  if(!empty($monst_theme_mod['heading_style_h2_enable_mob']) == true){
  
$mob_h2_font_sizecss = '';
$mob_h2_font_size = $monst_theme_mod['h2_typography_mobile']['font-size'];
...
$mob_h2_font_lheight= $monst_theme_mod['h2_typography_mobile']['line-height'];
...
if(!empty($monst_theme_mod['heading_style_h3_enable_desk']) == true){

  $desk_h3_font_sizecss = '';
  $desk_h3_font_size = $monst_theme_mod['h3_typography']['font-size'];
...
$css .= '@media(min-width:768px){ body h3 , h3 , h3 a  ' . ' {' . $desk_h3_font_sizecss . '}}';
  ...
  $desk_h3_font_weight = $monst_theme_mod['h3_typography']['font-weight'];
...
$css .= 'body h3 , h3 , h3 a  ' . ' {' . $desk_h3_font_weightcss . '}';
  ...
  $desk_h3_font_style = $monst_theme_mod['h3_typography']['font-style'];
...
$css .= 'body h3 , h3 , h3 a ' . ' {' . $desk_h3_font_stylecss . '}';
  ...
  $desk_h3_lineheight = $monst_theme_mod['h3_typography']['line-height'];
  ...
  if(!empty($monst_theme_mod['heading_style_h3_enable_mob']) == true){
  
$mob_h3_font_sizecss = '';
$mob_h3_font_size = $monst_theme_mod['h3_typography_mobile']['font-size'];
...
$mob_h3_font_lheight= $monst_theme_mod['h3_typography_mobile']['line-height'];
...
if(!empty($monst_theme_mod['heading_style_h4_enable_desk']) == true){

  $desk_h4_font_sizecss = '';
  $desk_h4_font_size = $monst_theme_mod['h4_typography']['font-size'];
...
$css .= '@media(min-width:768px){ body h4 , h4 , h4 a  ' . ' {' . $desk_h4_font_sizecss . '}}';
  ...
  $desk_h4_font_weight = $monst_theme_mod['h4_typography']['font-weight'];
...
$css .= 'body h4 , h4 , h4 a  ' . ' {' . $desk_h4_font_weightcss . '}';
  ...
  $desk_h4_font_style = $monst_theme_mod['h4_typography']['font-style'];
...
$desk_h4_lineheight = $monst_theme_mod['h4_typography']['line-height'];
...
$css .= '@media(min-width:768px){ body h4 , h4 , h4 a  ' . ' {' . $desk_h4_lineheightcss . '}}';
  ...
  if(!empty($monst_theme_mod['heading_style_h4_enable_mob']) == true){
  
$mob_h4_font_sizecss = '';
$mob_h4_font_size = $monst_theme_mod['h4_typography_mobile']['font-size'];
...
$mob_h4_font_lheight= $monst_theme_mod['h4_typography_mobile']['line-height'];
...
if(!empty($monst_theme_mod['heading_style_h5_enable_desk']) == true){

  $desk_h5_font_sizecss = '';
  $desk_h5_font_size = $monst_theme_mod['h5_typography']['font-size'];
...
$css .= '@media(min-width:768px){ body h5 , h5 , h5 a  ' . ' {' . $desk_h5_font_sizecss . '}}';
  ...
  $desk_h5_font_weight = $monst_theme_mod['h5_typography']['font-weight'];
...
$css .= 'body h5 , h5 , h5 a   ' . ' {' . $desk_h5_font_weightcss . '}';
  ...
  $desk_h5_font_style = $monst_theme_mod['h5_typography']['font-style'];
...
$desk_h5_lineheight = $monst_theme_mod['h5_typography']['line-height'];
...
$css .= '@media(min-width:768px){ body h5 , h5 , h5 a  ' . ' {' . $desk_h5_lineheightcss . '}}';
  ...
  if(!empty($monst_theme_mod['heading_style_h5_enable_mob']) == true){
  
$mob_h5_font_sizecss = '';
$mob_h5_font_size = $monst_theme_mod['h5_typography_mobile']['font-size'];
...
$mob_h5_font_lheight= $monst_theme_mod['h5_typography_mobile']['line-height'];
...
if(!empty($monst_theme_mod['heading_style_h6_enable_desk']) == true){

  $desk_h6_font_sizecss = '';
  $desk_h6_font_size = $monst_theme_mod['h6_typography']['font-size'];
...
$css .= '@media(min-width:768px){ body h6 , h6 , h6 a  ' . ' {' . $desk_h6_font_sizecss . '}}';
  ...
  $desk_h6_font_weight = $monst_theme_mod['h6_typography']['font-weight'];
...
$css .= 'body h6 , h6 , h6 a   ' . ' {' . $desk_h6_font_weightcss . '}';
  ...
  $desk_h6_font_style = $monst_theme_mod['h6_typography']['font-style'];
...
$css .= 'body h6 , h6 , h6 a  ' . ' {' . $desk_h6_font_stylecss . '}';
  ...
  $desk_h6_lineheight = $monst_theme_mod['h6_typography']['line-height'];
...
$mob_h6_font_sizecss = '';
$mob_h6_font_size = $monst_theme_mod['h6_typography_mobile']['font-size'];
...
$mob_h6_font_lheight= $monst_theme_mod['h6_typography_mobile']['line-height'];
...
/*---typography-for-h6-mobile-*/
  ...
  if(!empty($monst_theme_mod['body_custom_fonts']) == true){

$body_font_sizecss = '';
$body_font_size = $monst_theme_mod['body_typography']['font-size'];
...
$body_font_weightcss = '';
$body_font_weight = $monst_theme_mod['body_typography']['font-weight'];
...
$body_font_stylecss = '';
$body_font_style = $monst_theme_mod['body_typography']['font-style'];
...
$body_lineheightcss = '';
$body_lineheight = $monst_theme_mod['body_typography']['line-height'];
