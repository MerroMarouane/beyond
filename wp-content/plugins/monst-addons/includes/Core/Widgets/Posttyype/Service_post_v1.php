...
class Service_post_v1 extends \Elementor\Widget_Base
{
    ...
    {
        return 'monst-service-post-v1';
    }

    public function get_title()
    {
        return __('Service Post  V1', 'monst-addons');
    }
    ...
    protected function register_controls(){
        ...
        [ 
            'label' => __('Service Content', 'monst-addons'),
        ...
        $this->add_control(
            'service_style',
            [
                'label' => __('Service style', 'monst-addons'),
        ...
        $this->add_control(
			...
			'options' => monst_get_service_categories(),
			]
        );
    ...
    $this->add_group_control(
        ...
        [
            ...
            'name' => 'title_typo',
            'selector' => '{{WRAPPER}} .card_post_service.one .content_box .title a ',
        ]
    );
    $this->add_control(
        'title_color',
         [
            ...
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one .content_box .title a ' => 'color: {{VALUE}}!important;',
            ],
         ]
    );
    ...
    $this->add_group_control(
        ...
        [
            ...
            'name' => 'desc_typo',
            'selector' => '{{WRAPPER}} .card_post_service.one .content_box p ',
        ]
    );
    $this->add_control(
        'description_color',
         [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one .content_box p ' => 'color: {{VALUE}}!important;',
            ],
         ]
    );
    $this->add_control(
        'icon_color',
         [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one .content_box .icon_box span  ' => 'color: {{VALUE}}!important;',
            ],
         ]
    );
    $this->add_control(
        'icon_bg_color',
         [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one .content_box .icon_box ' => 'background: {{VALUE}}!important;',
            ],
         ]
    );
    $this->add_control(
        'hover_icon_color',
         [
            'label' => __('Icon Hover Color', 'monst-addons'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one:hover .content_box .icon_box span ' => 'color: {{VALUE}}!important;',
            ],
         ]
    );
    $this->add_control(
        'hover_icon_bg_color',
         [
            'label' => __('Icon Hover Bg Color', 'monst-addons'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one:hover .content_box .icon_box ' => 'background: {{VALUE}}!important;',
            ],
         ]
    );
    ...
    $this->add_control(
        'service_bg_color',
         [
            'label' => __('Service Bg Color', 'monst-addons'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one' => 'background: {{VALUE}}!important;',
            ],
         ]
    );
    $this->add_control(
        'service_bord_color',
         [
            'label' => __('Service Border Color', 'monst-addons'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .card_post_service.one' => 'border-color: {{VALUE}}!important;',
            ],
         ]
    );
...
<section class="service_post position-relative">
    <div
        ...
        <?php if($service_query->have_posts()):
                            ...
                            $service_icon_or_image = get_post_meta(get_the_ID() , 'service_icon_or_image' , true);
                            $service_icon = get_post_meta(get_the_ID() , 'service_icon' , true);
                            $service_icon_images = get_post_meta(get_the_ID() , 'service_icon_image' , true);
                            $service_column = $settings['service_column'];
        ...
        <?php // blog style ?>
         ...
         <article <?php post_class($service_column); ?>>
            <div class="card_post_service one clearfix <?php if(has_post_thumbnail()): ?>has_images<?php else: ?>no_images<?php endif; ?>"
                ...
                <div class="content_box">
                    ...
                    <?php endif; ?>
                    <?php if($service_icon_or_image == 'image'): ?>
                    <?php if(!empty($service_icon_images)): ?>
                                  <div class="icon_box"> 
                                        <img src="<?php echo esc_url($service_icon_images['url']); ?>" class="img-fluid"  alt="icon"> 
                                  </div>
                    <?php endif; ?>    
                    <?php elseif($service_icon_or_image == 'icon'): ?>
                        <div class="icon_box"> 
